...
const getAccessibilities = async (roles) => {
    ...
    const results = await fetch(`/res/system_accessibility?$ids=${uniqueKeys}`)
    return results;
};

module.exports = async (req) => {
    let roles = await fetch('/res/system_roles');
    roles = roles.docs;
        ...
        <script>
            (function(exports){
                ...
                function loadAccessibilitiesCatalog(){
                    fetch('/res/system_accessibility')
                ...
                function refreshRoleListTable(){
                    fetch('/res/system_roles').then(function(results){
                        return results.json();
                    }).then(function(result){
